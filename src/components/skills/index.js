        ...
        <Skill.InfoContainer>
          <Skill.InfoWrapper id="skills">
            ...
            >
              ...
              <Skill.InfoTextSub>
                My name is Eric, shin. I have passion to build the code on the
                front-end side. I have a Advanced-diploma on Cenetennial
                college. I have many expriences on the workplace. I was recently
                working in Siemens. So I had a lot of chances to get Experiences
            ...
            <Skill.Infrologocontainer data-aos="zoom-in-up">
              ...
              <Skill.IntroAllcoverLogo>
                ...
                <Skill.IntroLogop>
                  React (Redux Redux-saga, GraphQL & Apollo)
                </Skill.IntroLogop>
              </Skill.IntroAllcoverLogo>
            ...
            <Skill.SchoolContainer data-aos="zoom-in">
              <Skill.Schoolcontainercover>
                ...
                <Skill.Schoolinfocontainer>
                  <Skill.SchoolinfoH3>
                    Diploma Awarded: Electronics Engineering technician
                  </Skill.SchoolinfoH3>
                  <Skill.Schoolinfoh5>
                    2016,September - 2018,April
                  </Skill.Schoolinfoh5>
                </Skill.Schoolinfocontainer>
              </Skill.Schoolcontainercover>
              ...
              <Skill.Schoolcontainercover>
                ...
                <Skill.Schoolinfocontainer>
                  <Skill.SchoolinfoH3>
                    Advance Diploma Awarded: Electronics Engineering technology
                  </Skill.SchoolinfoH3>
                  <Skill.Schoolinfoh5>
              ...
              <Skill.Schoolcontainercover>
                ...
                <Skill.Schoolinfocontainer>
                  <Skill.SchoolinfoH3>
                    Telecommunication Technician(FA)
                  </Skill.SchoolinfoH3>
                  <Skill.Schoolinfoh5>
                    2020,September - 2021,April
                  </Skill.Schoolinfoh5>
                </Skill.Schoolinfocontainer>
              </Skill.Schoolcontainercover>
